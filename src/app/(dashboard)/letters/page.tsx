                                ...
                                >
                                    <TableHeader className="sticky top-0 z-10 bg-background shadow-sm">
                                        <TableRow>
                                            ...
                                            {columnVisibility.id && <TableHead className="w-[4%] text-center">ID</TableHead>}
                                            {columnVisibility.code && <TableHead className="w-[8%]">Code</TableHead>}
                                            {columnVisibility.organization && <TableHead className="w-[13%]">Sender/Organization of the letter</TableHead>}
                                            ...
                                            {columnVisibility.title && <TableHead className="w-[17%]">Subject/Content of the Letter</TableHead>}
                                            {columnVisibility.department && <TableHead className="w-[12%]">Section</TableHead>}
                                            {columnVisibility.assignee && <TableHead className="w-[9%]">Assignee</TableHead>}
                                            {columnVisibility.date && <TableHead className="w-[9%]">Received Date</TableHead>}
                                            {columnVisibility.status && <TableHead className="w-[8%] text-center">Status</TableHead>}
                                            {columnVisibility.other && <TableHead className="w-[9%]">Cheque no /Money Order No</TableHead>}
                                            {/* Actions column — always visible */}
                                        ...
                                        <TableBody>
                                            {letters.map((item, index) => (
                                                <TableRow key={item.id} className="hover:bg-gray-50 dark:hover:bg-gray-800/50">
                                                    ...
                                                    {columnVisibility.organization && (
                                                        <TableCell className="w-[13%] align-top">
                                                    ...
                                                    {columnVisibility.title && (
                                                        <TableCell className="w-[17%] align-top">
                                                            <div className="whitespace-pre-wrap break-words">{item.subject}</div>
                                                        </TableCell>
                                                    )}
                                                    {columnVisibility.department && (
                                                    ...
                                                    {columnVisibility.assignee && (
                                                        <TableCell className="w-[9%] align-top">
                                                            <div className="whitespace-pre-wrap break-words">{item?.assignee || "—"}</div>
                                                        </TableCell>
                                                    )}
                                                    {columnVisibility.date && (
                                                        <TableCell className="w-[9%] align-top">
