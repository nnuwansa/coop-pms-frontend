...
import {ArrowLeft, Home, Lock, LockOpen} from "lucide-react";
                ...
                <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 space-y-8">
                    <div className="flex justify-center">
                        <div className="relative">
                            <LockOpen className="w-24 h-24 text-primary/20 absolute -rotate-12 translate-x-4"/>
                    ...
                    <div className="text-center space-y-3">
                        ...
                        <p className="text-gray-600 dark:text-gray-400 max-w-md mx-auto">
                            {"The page you're looking for unable to access. You may not have the necessary permissions to view this page."}
                        </p>
                    </div>
                    ...
                    <div
                        ...
                        <p className="font-mono mt-1">Error Code: PMS-403-FORBIDDEN</p>
                    </div>
                </div>
            </div>
        </div>
